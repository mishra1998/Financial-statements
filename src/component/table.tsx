...
import './table.css'
import PlaneTable from "./plane-table";
...
export const Table: React.FC = () => {
  ...
  const [total, setTotal] = useState<TotalRow>({
    data2021: 45587,
    data2022: 51036,
    data2024: 49761,
    varience: -1275,
  ...
  const handleVarience = (item: DataRow, e: ChangeEvent<HTMLInputElement>) => {
  ...
  const updateTotals = (updatedData: DataRow[]) => {
  ...
  return (
    <>
      <div style={{ border: "1px solid black" }}>
        ...
        <button onClick={() => setNewRow({ category: "", data2021: 0, data2022: 0, data2024: 0, varience: 0, variencePer: 0 })}>
          Add Row
        </button>
        {newRow && (
          <div>
